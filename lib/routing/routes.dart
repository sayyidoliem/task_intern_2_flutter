        ...
        return MaterialPageRoute(
          ...
          builder: (context) => MultiBlocProvider(
            providers: [
              ...
              BlocProvider(
                create: (context) => UserBloc(userService: UserRemoteService())
                  ..add(GetUserEvent()),
              ),
              // BlocProvider.value(value: userBloc),
              BlocProvider(
                create: (context) => PostBloc(postService: PostRemoteService())
                  ..add(GetPostEvent()),
              ),
              BlocProvider(
                create: (context) =>
                    CommentBloc(commentService: CommentRemoteService())
                      ..add(GetCommentEvent()),
              ),
              BlocProvider(
                create: (context) =>
                    AlbumBloc(albumService: AlbumRemoteService())
                      ..add(GetAlbumEvent()),
              ),
            ],
            child: HomePage(),
